...
score_thread = threading.Thread(target=update_score) # subject for removal
player_pos_thread = threading.Thread(target=update_player_pos) # subject for removal
